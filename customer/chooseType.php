...
if (!isset($_SESSION['custID'])&&!isset($_SESSION['custEmail'])) {
 ...
 {
   $_SESSION['message'] = "Enter budget Amount first";
   $_SESSION['msg_type'] = "danger";
...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <section class="ftco-section ftco-no-pt ftco-no-pb">
      <br>
        <h3 class="text-center">Choose Shopping Type</h3>
      <br>
      <?php
          ...
          <div class="col-lg-4 text-center d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services p-4 py-md-5">
              ...
              <div class="media-body">
                <h4 class="heading">In-store Shopping Scanner</h4>

                <p><a href="scanner/scanProduct.php?type=shop&id=<?php echo $id ?>" class="btn-custom">
<img style="width:300px;height:270px; border-radius: 15px;" src="scanImg/scan.jpg" class="img-responsive" alt="">
          ...
          <div class="col-lg-4 text-center d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services p-4 py-md-5">
              ...
              <div class="media-body">
                <h4 class="heading">Online Shopping</h4>

                <p><a href="productList.php?type=shop&id=<?php echo $id ?>" class="btn-custom">
<img style="width:300px;height:270px; border-radius: 15px;" src="scanImg/banner.jpg" class="img-responsive" alt="">
