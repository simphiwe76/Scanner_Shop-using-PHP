...
<br>
    <section class="ftco-section ftco-no-pt ftco-no-pb">
      <br>
        <h4 class="text-center">Customer Order Items</h4>
      <br>
			<div class="container">
          ...
          $sql = "SELECT* FROM customerorderitem WHERE orderNumber = '$itemId';";
          ...
          <td style="text-align: center;"><?php echo $row['orderItemDestr']; ?></td>
          <td style="text-align: center;"><?php echo "R".$row['orderItemPrice']; ?></td>
          <td style="text-align: center;"><?php echo $row['orderItemQuant']; ?></td>
          <td style="text-align: center;"><?php echo $row['orderItemTotal']; ?></td>
          <td style="text-align: center;">

              <img style="width:100px;height:50px;" src="<?php echo '../admin/img/'.$row['orderItemImg']; ?>" >
          </td>
