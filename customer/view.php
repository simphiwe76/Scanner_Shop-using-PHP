	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown04">
                ...
                <a class="dropdown-item" href="view.php">Update</a>
              </div>
            </li>
    ...
    <section class="ftco-gallery">
        ...
        <br>
          ...
          <div class="col-sm-4">
            ...
            <form action="view.php" method="post" novalidate="novalidate">



     <div class="form-group">
        <label for="exampleInputEmail1">Customer Name</label>
        <input type="text" name="name"  class="form-control"  style="border-radius: 50px;"  readonly value="<?php echo"$cust_name"?>">

        <div class="form-group">
           <label for="exampleInputEmail1">Customer Surname</label>
           <input type="text" name="surname"  class="form-control"  style="border-radius: 50px;" readonly value="<?php echo"$cust_surname"?>">
        </div>
     </div>

     <div class="form-group">
        <label for="exampleInputEmail1">Customer Email</label>
        <input type="email" name="email"  class="form-control"  style="border-radius: 50px;"  readonly value="<?php echo"$cust_email"?>">
     </div>
     <div class="form-group">
       <label for="exampleInputEmail1">Customer Gender</label>
       <input type="text" name="gender"  class="form-control"  style="border-radius: 50px;"  readonly  value="<?php echo"$cust_gender"?>">
        </select>
     </div>
        ...
        <p></p>
                                 ...
                                 <?php
                                        ...
                                        <div class="col-md-12 text-center ">
                                                 <button class="btn btn-primary py-3 px-4" type="submit" name="btnRegister">Done</button>
                                        </div>
                            </form>
