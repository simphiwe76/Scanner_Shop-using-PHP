...
$numR = mysqli_num_rows($result);
  ...
  if (isset($_POST['btnRegister']))
  {
      ...
      if (empty($email))
      {
        ...
        $_SESSION['message'] = "Email is empty please populate";
        $_SESSION['msg_type'] = "danger";
        echo "<script>location.replace('profile_delete.php');</script>";
        exit();
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown04">
                ...
                <a class="dropdown-item" href="profile_delete.php">Update</a>
              </div>
            </li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          ...
          <!--	<p class="breadcrumbs"><span class="mr-2"><a href="index.php">Update</a></span> <span>Profile</span></p>-->
            <h1 class="mb-0 bread">Delete Profile</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="ftco-gallery">
        ...
        <br>
          ...
          <div class="col-sm-4">
            ...
            <form action="profile_delete.php" method="post" novalidate="novalidate">
        ...
        <p></p>
                                 ...
                                 <?php
                                        ...
                                        <div class="col-md-12 text-center ">
                                                 <button class="btn btn-primary py-3 px-4" type="submit" name="btnRegister">Delete account</button>
                                        </div>
                            </form>
                            </div>
    		</div>
