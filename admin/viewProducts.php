...
<div class="card">
  ...
  <tbody>
    <?php
        ...
        $sql = "SELECT* FROM product WHERE storeID = '$adminStoreID';";
        $result = mysqli_query($conn,$sql);
    ...
    ?>
      <tr>
          <td style="text-align: center;"><?php echo $row['productNo']; ?></td>
          <td style="text-align: center;"><?php echo $row['productName']; ?></td>
          <td style="text-align: center;"><?php echo "R".$row['productPrice']; ?></td>
          <td style="text-align: center;"><?php echo $row['prodQuantity']; ?></td>
          ...
          <td>
                <a class="btn btn-primary" href="prodEdit.php?type=update&id=<?php echo $row['prodID']; ?>">Update</a>

                <a class="btn btn-danger" href="viewProducts.php?type=delete&id=<?php echo $row['prodID']; ?>">Delete</a>
          </td>
      </tr>
        <?php
