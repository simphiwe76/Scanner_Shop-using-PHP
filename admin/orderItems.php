      ...
      <div class="side-inner">
        ...
        <div class="nav-menu">
          ...
          <!--  <li><a href="add_Customers.php"><span class="icon-user-plus mr-3"></span>Add Customers</a></li>
            ...
            <li  class="nav-item active"><a href="orders.php"><span class="icon-eye mr-3"></span>Customer Orders</a></li>
          ...
          <?php
              if (isset($_SESSION['adminID']))
              {
                      ...
                      if ($numR== 1)
                      {
                          ...
                          echo "<h5 class='text-right'>Customer Name : ".$row['customerName']."</h5>";
                          echo "<h5 class='text-right'>Customer Surname : ".$row['customerSurname']."</h5>";
                      }
...
<div class="card">
  ...
  <div class="card-body">
      <h4 class="card-title">Customer Order Items</h4>
  ...
  <tbody>
    <?php
        ...
        $sql = "SELECT* FROM customerorderitem WHERE orderNumber = '$orderNo';";
        $result = mysqli_query($conn,$sql);
    ...
    ?>
      <tr>
          ...
          <td style="text-align: center;"><?php echo "R".$row['orderItemPrice']; ?></td>
          <td style="text-align: center;"><?php echo $row['orderItemQuant']; ?></td>
          <td style="text-align: center;"><?php echo 'R'.$row['orderItemTotal']; ?></td>

          <td style="text-align: center;">
            <?php
                $img = "img/".$row['orderItemImg'];
                echo "<img style='height: 20%;width: 20%;' class='card-img-top rounded mx-auto d-block' src='$img'>";
            ?>
          </td>
        ...
        {
                  echo "<td colspan='8'>No Product Found</td>";
        }
