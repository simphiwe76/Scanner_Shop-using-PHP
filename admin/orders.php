...
<div class="card">
  ...
  <div class="card-body">
      <h4 class="card-title">All Customer Orders</h4>
  ...
  <tbody>
    <?php
      ...
      {
              $sql = "SELECT* FROM customerorder WHERE storeID = '$adminStoreID' Order by orderDate Desc;";
              $result = mysqli_query($conn,$sql);
              $numR = mysqli_num_rows($result);
      }
    ...
    ?>
      <tr>
          ...
          <td  style="text-align: center;">
                <a class="btn btn-primary" href="orderItems.php?type=item&orderNo=<?php echo $row['orderNumber'].'&custID='.$row['customerID']; ?>">View Order Items</a>
...
{
    echo "<td colspan='5'>No Order Found</td>";
}
      ?>
